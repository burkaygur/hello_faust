/* ------------------------------------------------------------
name: "FaustSawtooth"
Code generated with Faust 2.19.0 (https://faust.grame.fr)
...
FaustSawtooth::FaustSawtooth(int sample_rate, int buffer_size)
{
    fBS = buffer_size;
    fDSP = new mydsp();
...
void FaustSawtooth::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

void FaustSawtooth::configureI2S(int sample_rate, int buffer_size, i2s_pin_config_t pin_config)
{
    #if A1S_BOARD
...
void FaustSawtooth::audioTaskHandler(void* arg)
{
    FaustSawtooth* audio = (FaustSawtooth*)arg;
    audio->audioTask();
}
